...
const skills = [
  ...
  {name:'Agile',
  image:ScrumImage,
  description:{'es':<span>Llevé a cabo un curso de capacitación del marco de trabajo <strong>Scrum</strong>, actualmente muy usado para agilizar el trabajo en equipo y que rinde frutos en términos de organización.<br/> Como dato curioso... Antes de llevar dicha capacitación, durante trabajos colaborativos usaba con mis equipos (por pura coincidencia) metodologías muy parecidas a los <strong>Sprint</strong> para organizarnos antes de iniciar cualquier labor.</span>,
